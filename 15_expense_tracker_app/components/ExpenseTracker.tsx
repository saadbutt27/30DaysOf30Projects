...
export default function ExpenseTracker() {
    ...
    const handelSaveEditExpense = (): void => {
        setExpenses(
    ...
    const totlExpenses = expenses.reduce((total, expense) =>  total + expense.amount, 0)
return (
        ...
        <Dialog open={showModal} onOpenChange={setShowModal}>
            <DialogContent className="bg-card p-6 rounded-lg shadow w-full max-w-md">
                ...
                <DialogFooter>
                    ...
                    <Button 
                        variant="outline" 
                        onClick={isEditing ? handelSaveEditExpense : handleAddedExpense}
                    >
