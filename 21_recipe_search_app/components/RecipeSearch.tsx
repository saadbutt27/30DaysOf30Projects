...
export default function RecipeSearch() {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-6xl mx-auto p-4 md:p-6 shadow-lg bg-background text-foreground">
        <header className="flex flex-col items-center mb-6">
            ...
            <form className="relative w-full max-w-md mb-6" onClick={handleSearch}>
                <Input
                    type="search"
        ...
        :
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                {recipes.map((recipe) => (
                    <Card className="roup relative" key={recipe.uri}>
                        <Image 
                            src={recipe.image}
                            alt={recipe.label}
                            width={400}
