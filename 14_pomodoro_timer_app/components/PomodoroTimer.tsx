...
export default function PomodoroTimer() {
    ...
    useEffect(() => {
        ...
        if (state.timerStatus === "running" && state.currentTime > 0) {
            console.log("timer running and current time > 0...")
    ...
    const handleStartPause = (): void => {
        console.log("Timer status: ", state.timerStatus)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-10">
            ...
            <div className="flex flex-col items-center justify-center gap-6">
                ...
                <div className="p-2">
                    <AlertDialog>
                        ...
                        <AlertDialogContent className="w-full max-w-2xl p-4 md:p-6 bg-white/90">
                            <AlertDialogHeader>
                                <AlertDialogTitle>
