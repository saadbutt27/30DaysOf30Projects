...
export default function CurrencyConverter() {
    ...
    const [targetCurrency , setTargetCurency] = useState<Currency>("PKR")
    ...
    const handleSourceCurrency = (value: Currency): void => {
        setSourceCurrency(value)
    }

    const handleTargetCurrencyChange = (value: Currency): void => {
        setTargetCurency(value)
    }
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-background shadow-lg p-10">
                        ...
                        <div className="grid grid-cols-[1fr_auto] items-center gap-2">
                            ...
                            <div className="grid grid-cols-[1fr_auto] items-center gap-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={handleSourceCurrency}
                                >
